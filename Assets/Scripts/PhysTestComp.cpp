...
namespace Alice
{
    ...
    void PhysicsTest::Start()
    {
        ...
        {
            ALICE_LOG_ERRORF("[PhysicsTest] Physics world not created! Check PhysicsSceneSettingsComponent.");
        }
